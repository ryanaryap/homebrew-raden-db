class MysqlAT93 < Formula
  ...
  on_arm do
    url "https://cdn.mysql.com/archives/mysql-9.3/mysql-9.3.0-macos15-arm64.tar.gz"
    sha256 "5b8ca2df717b04b79075ca5edc5723eee9e15fa811fc52e91974c6dc69a25d17"
  end

  on_intel do
    url "https://cdn.mysql.com/archives/mysql-9.3/mysql-9.3.0-macos15-x86_64.tar.gz"
